...
int main(int argc, char **argv) {
	...
	unsigned int first_path_inode_num = traverse_path(inode_table, first_arg_path_name);
	...
	unsigned int second_parent_inode_number = traverse_path(inode_table, second_parent_path_name);
	...
	unsigned int second_path_inode_num = traverse_path(inode_table, second_arg_path_name);
